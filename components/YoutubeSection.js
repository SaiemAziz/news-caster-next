...
const YoutubeSection = () => {
    return (<>
        ...
        <div className='w-full flex flex-col gap-5'>
            ...
            <iframe className='w-full' src="https://www.youtube.com/embed/GEumHK0hfdo" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen"></iframe>
            ...
            {/* 3rd vdo  */}
            <div className='bg-white'>
            <iframe className='w-full' src="https://www.youtube.com/embed/uTj-sc9pV7Y" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen"></iframe>
