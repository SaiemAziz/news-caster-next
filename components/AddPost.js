...
const AddPost = () => {
  ...
  return (
    <form onSubmit={handleForm} className="p-5 mx-auto lg:w-[900px] w-full">
      ...
      {load ? (
        <div className="max-w-md p-5 min-h-screen mx-auto flex flex-col items-center justify-center">
          <p className="text-center text-xl font-bold pt-5 text-primary">
            Fake News Detection
          </p>
          <p className="text-center text-xl font-bold pb-5 text-primary">
            Model Loading
          </p>
          <p className="text-center text-xl italic font-bold text-gray-400">
        ...
        <>
          ...
          <div className="flex gap-2 items-center">
            ...
            <select
              className="select select-info flex-grow my-5"
          ...
          {loadAdd ? (
            ...
            <input
              type="submit"
              className="btn btn-success w-full my-5 mb-10"
              value="SUBMIT"
            />
          )}
        </>
